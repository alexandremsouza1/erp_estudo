...
router.delete('/perguntas/:user_id_perguntas', bloqueioService.removerUsuarioListaNegraPerguntas)
...
router.delete('/compras/:user_id_compras', bloqueioService.removerUsuarioListaNegraCompras)
